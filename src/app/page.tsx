          ...
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                Soluciones rápidas y seguras para el transporte de carga.
                Conectamos camiones y motocicletas para entregas eficientes en cualquier lugar.
              </p>
            ...
            <div className="mt-16 flow-root sm:mt-24">
              <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 dark:bg-white/5 dark:ring-white/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                <Image
                  ...
                  alt="Logística de camiones y motos"
                  width={2432}
                  height={1442}
